...
class ModelArguments:
    ...
    # Fix error AttributeError: 'ModelArguments' object has no attribute 'batch_eval_metrics'
    # and 'ModelArguments' object has no attribute 'eval_strategy'
    # batch_eval_metrics: Optional[Sequence[str]] = field(default=None)
