...
# apptainer exec --nv /mimer/NOBACKUP/groups/scalablefl/containers/fm.sif bash -c source ~/.bashrc && export WANDB_MODE=offline && conda activate tinyllava && bash ./scripts/train/lora/finetune_tinyllama.sh
